...
- **Synonymtabelle.** `normalizeLabel` kennt „Attribut“, „Apposition“, „Adverbiale“, „Objekt“ nicht; solche Ausgaben werden „Sonstiges“. Wenn die Liste bleibt, wie sie ist, könnten wenigstens „Adverbiale“ → „Adverb“ und „Prädikatsnomen“ → „Prädikativum“ ergänzt werden. Mit der neuen KI-Anbindung ist das Modell allerdings ohnehin auf die erlaubten Labels festgelegt; die Tabelle betrifft dann nur noch den Weg über Kopieren und Einfügen.
